									...
									<CardBody isScrollable>
										<div className='row'>
											...
											<div className='col-4 mt-2'>
												<Link to='https://api.whatsapp.com/send?phone=635192125&text=Hola'>
													<Button
														className='btn btn-info'>
														<img className='pe-2' src='https://seeklogo.com/images/W/whatsapp-logo-112413FAA7-seeklogo.com.png' alt='WhatsApp'
															width={25}
														/>
														Enviar
													</Button>
								...
								<>
									<CardHeader>
										<CardLabel icon='Edit' iconColor='success'>
											...
											<CardSubTitle>Group Details</CardSubTitle>
										</CardLabel>
									</CardHeader>
									<CardBody isScrollable>
										<Card>
